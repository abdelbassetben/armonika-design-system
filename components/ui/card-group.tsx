...
function CardGroupHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-11 items-center px-3 pt-3 pb-2 **:data-[slot=card-header]:w-full **:data-[slot=card-header]:pb-0",
        className
      )}
      {...props}
    />
