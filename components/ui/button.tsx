...
const borderHairline = "border-[#00000014]";
const borderMuted = "border-[#0000000d]";

const shadowRestInsetSm =
  "shadow-[0_1px_2px_0_rgba(255,255,255,0.03)_inset,0_2px_1.5px_-0.5px_rgba(0,0,0,0.03)]";
...
const hoverShadowLiftStrong =
  "hover:shadow-[0_3px_3px_0_rgba(255,255,255,0.18)_inset,0_1px_1px_-0.5px_rgba(0,0,0,0.03),0_3px_3px_-1.5px_rgba(0,0,0,0.03),0_20px_20px_-12px_rgba(0,0,0,0.03)]";
const hoverShadowLiftSoft =
  "hover:shadow-[0_2px_3px_0_rgba(255,255,255,0.08)_inset,0_1px_1px_-0.5px_rgba(0,0,0,0.03),0_3px_3px_-1.5px_rgba(0,0,0,0.03),0_20px_20px_-12px_rgba(0,0,0,0.03)]";

const focusBorderDefault = "focus-visible:border-[rgba(0,0,0,0.08)]";
const focusRingOff = "focus-visible:ring-0";
const focusShadowPrimary =
  "focus-visible:shadow-[0_0_0_2px_rgba(0,85,255,0.20)]";
const focusShadowNeutral = "focus-visible:shadow-[0_0_0_2px_rgba(0,0,0,0.08)]";
const focusShadowDestructive =
  "focus-visible:shadow-[0_0_0_2px_rgba(237,64,48,0.20)]";
const focusShadowSuccess =
  "focus-visible:shadow-[0_0_0_2px_rgba(64,155,63,0.20)]";
...
const buttonVariants = cva(
  cn(
    ...
    "disabled:pointer-events-none disabled:border-0 disabled:bg-sidebar disabled:text-disable",
